                                ...
                                <div class="basic-form">
                                    <form>
                                        <div class="form-group">
                                            ...
                                            <select name="programme" id="prg" class="form-control" onchange="checkme()">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="semester" id="c1" class="form-control">
                                                <option value="">Select</option>
                                            }
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="day" id="d1" class="form-control">
                                                <option value="">Select</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="time" name="time_start" class="form-control" id="stime">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="time" name="time_end" class="form-control" id="etime">
                                        ...
                                        @endforeach
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input name="courseid" id="cid" class="form-control">
