    ...
    <script src="{{asset('client/js/jquery.slimscroll.js')}}"></script>
    <!--Wave Effects -->
    <script src="{{asset('client/js/waves.js')}}"></script>
    <!--Menu sidebar -->
    <script src="{{asset('client/js/sidebarmenu.js')}}"></script>
    <!--stickey kit -->
    <script src="{{asset('client/assets/plugins/sticky-kit-master/dist/sticky-kit.min.js')}}"></script>
    <!--Custom JavaScript -->
...
<!-- Mirrored from wrappixel.com/demos/admin-templates/monster-admin/main/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Jan 2018 09:55:36 GMT -->
</html>
